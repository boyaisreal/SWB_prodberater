		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapuimrlearnodatadraftone-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuimrlearnodatadraftone-display": {
								"semanticObject": "sapuimrlearnodatadraftone",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.mr.learn.odatadraftone",
									"url": sap.ui.require.toUrl("sap/ui/mr/learn/odatadraftone")
								}
							}
						}
					}
